...
public class PrintManagerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!bluetoothAdapter.isEnabled()) {
            ...
            // Normally you prompt to turn it on, simplified here for brevity
            return;
        }
    ...
    private void renderHtmlToBitmap() {
        ...
        String fullHtml = "<html><head><style>body { margin: 0; padding: 0; background: white; width: 384px; }</style></head><body>" 
    ...
    private void takeSnapshot() {
        ...
        offscreenWebView.layout(0, 0, offscreenWebView.getMeasuredWidth(), offscreenWebView.getMeasuredHeight());

        try {
            receiptBitmap = Bitmap.createBitmap(offscreenWebView.getMeasuredWidth(), offscreenWebView.getMeasuredHeight(), Bitmap.Config.ARGB_8888);
            ...
            statusText.setText("Render Error!");
            e.printStackTrace();
        }
    }
