...
public class PrintManagerActivity extends Activity {
    ...
    private void renderHtmlToBitmap() {
        ...
        settings.setDefaultFontSize(8); // Match the small font requested
        ...
        String fullHtml = "<html><head><style>body { margin: 0; padding: 0; background: white; width: 576px; }</style></head><body>" 
